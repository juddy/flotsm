...
#
# Purpose:
#	Demonstrate the output of JPGs.
#	The point of this demo is that ImageMagick
#	alone is all that is required to output JPGs.
#
# V 1.01 20-Feb-2002
# ------------------
...
#
# Output files:
#	/apache/htdocs/im-hax-gif2jpg-1.jpg
#
# Note:
#	o tab = 4 spaces || die.
...
my($output_file_name)	=
	$doc_root_name . '/im-hax-png2jpg-1.jpg';
