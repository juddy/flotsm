...
<html>
<head>
<title>flotsm compositing example</title>
<style>
<!--
	body {
...
<table cellspacing="1" cellpadding="2">
 ...
 <tr>
  ...
  <tr>
  <td class="main"><b>Flotsmize:</b></td>
 ...
 <tr>
  ...
  <tr>
  <td class="main"><b>Information:</b></td>
  <td class="main" colspan="2">Caption (max. 256 Chars): <input type="text" size="256" maxlength="256" name="caption" value="<?=isset($_POST['caption'])?$_POST['caption']:'made @ flotsm.com'?>"></td>
 </tr>
